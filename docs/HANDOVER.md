...
- 官方目前提供 12 份歷屆試卷，共 600 題；已匯入 350 題：初級 6 份共 300 題
  （114 年第四次、115 年第一次、115 年第二次），以及 114 年第二次中級
  第一科 50 題。
- 最新 114 年 9 月版官方樣題共 115 題；尚未匯入。
- 114 年 1 月舊版樣題共 25 題，列為重複題與版本稽核，不直接加入目標。
- 已匯入的 350 題與官方答案均已逐頁核對；目前僅 3 題有實質 A～D 詳解初稿，
  其餘 347 題為 `missing`，尚未有任何題目完成人工複核。
- 專案目前採兩階段執行：第一階段先完成 715 題全部匯入與答案核對，第二階段
  才統一處理全部詳解。
- 下一個內容工作為匯入 114 年第二次中級第二、三科共 100 題；這兩科有 17 題
  內嵌官方 PDF 圖片，需先讓題目資料與網站支援附圖，才可匯入。暫不撰寫詳解。
