...
網站目前已收錄 114 年第四次初級兩科官方公告試題，共 100 題：

- 第一科「人工智慧基礎概論」50 題。
- 第二科「生成式 AI 應用與規劃」50 題。
- 題目與答案已逐頁對照官方 PDF。
- 點選選項後會鎖定答案，並顯示答對／答錯、正確答案與 A～D 選項解析。
- 可依科目篩選、只看錯題，作答進度保存在瀏覽器本機。

本站詳解是 AI 輔助撰寫的初稿，不是官方詳解，目前 100 題均尚待獨立人工
複核。原有 4 題非官方介面示範題已全部移除，不列入題庫及統計。
